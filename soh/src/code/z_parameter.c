...
void Interface_ChangeHudVisibilityMode(u16 alphaType) {
    if (alphaType != gSaveContext.hudVisibilityMode) {
        osSyncPrintf("ＡＬＰＨＡーＴＹＰＥ＝%d  LAST_TIME_TYPE=%d\n", alphaType, gSaveContext.prevHudVisibilityMode);
        gSaveContext.hudVisibilityMode = gSaveContext.nextHudVisibilityMode = alphaType;
